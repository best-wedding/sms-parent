...
export default function Title({handleSearch, course}) {
  return (
    <div className="pb-5 border-b border-gray-200 sm:flex sm:items-center sm:justify-between">
      <h3 className="text-lg font-medium leading-6 text-gray-900 capitalize">{course}</h3>
      <div className="mt-3 sm:mt-0 sm:ml-4">
        ...
        <div className="flex rounded-md shadow-sm">
          ...
          {/* <SlideOver title="Add Students" Component={Component} /> */}
        </div>
      </div>
    </div>
  )
